<div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="d-flex justify-content-end">
                        <button wire:click.prevent="createUser" class="btn btn-primary mb-2">
                            <i class="fa fa-plus-circle mr-2"> Add User</i>
                        </button>
                    </div>
                    <div class="card">
                        <div class="card-body">
    ...
    <!-- Modal -->
    <div class="modal fade" id="form" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
